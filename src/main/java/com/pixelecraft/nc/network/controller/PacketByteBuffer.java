...
public class PacketByteBuffer extends ByteBuf {
    private final ByteBuf buf;

    public PacketByteBuffer(ByteBuf wrapped) {
        this.buf = wrapped;
    }
    ...
    public String readStringFromBuffer(int maxLength) {
        ...
        if (i > maxLength * 4) {
            ...
            String s = new String(this.buf.readBytes(i).array(), Charsets.UTF_8);
    ...
    public PacketByteBuffer writeString(String string) {
