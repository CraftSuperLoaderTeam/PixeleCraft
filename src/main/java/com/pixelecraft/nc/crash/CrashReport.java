...
public class CrashReport {
    private static final Logger logger = Logger.getLogger(CrashReport.class);
    ...
    private void populateEnvironment() {
        this.theReportCategory.addCrashSectionCallable("Minecraft Version", new Callable<String>() {
            public String call() {
                return MetaData.minecraft_version;
            }
        });
    ...
    public boolean saveToFile(File toFile) {
        if (this.crashReportFile != null) {
            ...
            try {
                ...
                logger.log(Level.SEVERE,"Could not save crash report to " + toFile, throwable);
                return false;
            }
        }
    }
