...
import com.pixelecraft.nc.util.event.ClickEvent;
import com.pixelecraft.nc.util.event.HoverEvent;
import com.pixelecraft.nc.util.text.TextFormatting;
...
public class ChatStyle {
    ...
    private static final ChatStyle rootStyle = new ChatStyle() {
        ...
        public ChatStyle setColor(TextFormatting color) {
            ...
            if (p_deserialize_1_.isJsonObject()) {
                ...
                if (jsonobject == null) {
                    ...
                    if (jsonobject.has("color")) {
                        chatstyle.color = (TextFormatting) p_deserialize_3_.deserialize(jsonobject.get("color"), TextFormatting.class);
                    }
