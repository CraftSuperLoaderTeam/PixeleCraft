...
import com.pixelecraft.nc.util.ChatComponentTranslationFormatException;
import com.pixelecraft.nc.util.ChatStyle;
import com.pixelecraft.nc.util.IChatComponent;
import com.pixelecraft.nc.util.StatCollector;
...
public class ChatComponentTranslation extends ChatComponentBase {
    ...
    protected void initializeFromFormat(String format) {
        ...
        try {
            ...
            for (; matcher.find(j); j = l) {
                ...
                if (k > j) {
                    ChatComponentString chatcomponenttext = new ChatComponentString(String.format(format.substring(j, k), new Object[0]));
                ...
                if ("%".equals(s2) && "%%".equals(s)) {
                    ChatComponentString chatcomponenttext2 = new ChatComponentString("%");
            ...
            if (j < format.length()) {
                ChatComponentString chatcomponenttext1 = new ChatComponentString(String.format(format.substring(j), new Object[0]));
    ...
    private IChatComponent getFormatArgumentAsComponent(int index) {
        if (index >= this.formatArgs.length) {
            ...
            if (object instanceof IChatComponent) {
                ...
                ichatcomponent = new ChatComponentString(object == null ? "null" : object.toString());
    ...
    public String getUnformattedComponentText() {
        ...
        for (IChatComponent ichatcomponent : this.children) {
            stringbuilder.append(ichatcomponent.getUnformattedComponentText());
        }
    ...
    public String getUnformattedTextForChat() {
        ...
        for (IChatComponent ichatcomponent : this.children) {
            stringbuilder.append(ichatcomponent.getUnformattedText());
        }
