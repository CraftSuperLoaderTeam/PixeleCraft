...
public class CryptManager {
    private static final Logger LOGGER = Logger.getLogger(CryptManager.class.getSimpleName());
    ...
    public static KeyPair generateKeyPair() {
        try {
            ...
            LOGGER.log(Level.SEVERE,"Key pair generation failed!");
            return null;
        }
    }
    ...
    public static PublicKey decodePublicKey(byte[] encodedKey) {
        ...
        LOGGER.log(Level.SEVERE,"Public key reconstitute failed!");
        return null;
    }
    ...
    private static byte[] cipherOperation(int opMode, Key key, byte[] data) {
        ...
        LOGGER.log(Level.SEVERE,"Cipher data failed!");
        return null;
    }
    ...
    private static Cipher createTheCipherInstance(int opMode, String transformation, Key key) {
        ...
        LOGGER.log(Level.SEVERE,"Cipher creation failed!");
        return null;
    }
